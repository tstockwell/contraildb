 ...
 */
public class ContrailBTreeTests extends ContrailTestCase {
	...
	public void testIncreasingInserts() throws Throwable {
		runTest(new ContrailAction() {
			@Override
			protected void action() throws Pausable, Exception {
				IEntityStorage.Session storage= new EntityStorage(new RamStorageProvider()).connect().get();
	...
	public void testDecreasingInserts() throws Throwable {
		runTest(new ContrailAction() {
			@Override
			protected void action() throws Pausable, Exception {
				IEntityStorage.Session storage= new EntityStorage(new RamStorageProvider()).connect().get();
	...
	public void testIncreasingDeletes() throws Throwable {
		runTest(new ContrailAction() {
			@Override
			protected void action() throws Pausable, Exception {
				IEntityStorage.Session storage= new EntityStorage(new RamStorageProvider()).connect().get();
	...
	public void testDecreasingDeletes() throws Throwable {
		runTest(new ContrailAction() {
			@Override
			protected void action() throws Pausable, Exception {
				IEntityStorage.Session storage= new EntityStorage(new RamStorageProvider()).connect().get();
	...
	public void testIterators() throws Throwable {
		runTest(new ContrailAction() {
			@Override
			protected void action() throws Pausable, Exception {
				IEntityStorage.Session storage= new EntityStorage(new RamStorageProvider()).connect().get();
